...
function DropdownMenuItem({
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				"flex items-center text-muted hover:text-foreground relative px-3 py-2 hover:bg-border cursor-pointer rounded-lg justify-between space-x-2 text-sm transition-all !outline-none",
				className
			)}
			{...props}
		/>
